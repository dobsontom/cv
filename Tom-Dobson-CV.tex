...
\begin{itemize}
  ...
  \item At the BBC, built pipelines consolidating over 6m rows of survey data behind a self-service
        Tableau front end
  \item Automated the detection and publicising of Tableau User Group events with Python, Snowflake,
        and GitHub Actions, lifting engagement around \cvmetric{80\%}
\end{itemize}
...
\cvskillline{Infrastructure}{Kubernetes (EKS, Helm, GitOps), OpenTofu and Terraform, AWS (IAM, RDS
  and Aurora, S3, Athena, Identity Center), Docker, GitHub Actions}
