...
\begin{itemize}
  \item Cut Snowflake spend \cvmetric{46\%}, saving around \$100k per year, by removing unused and
        over-scheduled compute and sizing each warehouse, Gen2 included, on measured workload
  \item Migrated every ingestion source to self-hosted Airbyte on EKS and retired every paid
        ingestion platform, cutting ETL licence spend \cvmetric{94\%}, around \$60k per year
